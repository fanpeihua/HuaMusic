package fanpeihua.huamusic.common;
...
public class Constants {
    ...
    public static final int OP_PLAYLISt = 2; // 修改
    ...
    public static final String PLAYLIST_DOWNLOADID = "download";
    // 百度歌单
    ...
    // 虾米歌单
    public static final String PLAYLIST_XM_ID = "playlist_xm";
    // 在线歌单
    ...
    public static final String NETEASE_ARITIST_LIST = "netbase_artist_list";
